...
//	return date
	...
	/**
	 * This method is used to calculate the Total Test execution Time
	 * 
	 * 
	 */
public static void calculateTestExecutionTime(){
		
		iTestEndTime = System.currentTimeMillis(); //Newly added
		iTestExecutionTime = (iTestEndTime-iTestStartTime)/1000.000;//Newly added
	}
